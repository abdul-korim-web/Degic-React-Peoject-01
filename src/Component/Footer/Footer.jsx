...
const Footer = () => {
    const FooterList = [
        ...
        },
        {
            ...
            footerLinks: [`Design Systems`, `Themes & Templates`, `Mockups`, `Presentations`, `Wireframes Kits`, `UI Kits`]
        },
        {
            footerTitel: `Legals`,
        ...
        {
            footerTitel: `Blog`,
            footerLinks: [`Business Stories`, `Digital Store`, `Learning`, `Social Media`]
        },
    ];
    ...
    return (
        <>
            <section className="footer bg-black rounded-2xl mt-10 mb-2 md:flex md:justify-around md:items-start p-5">
                ...
                <div className='FooterLink flex flex-col justify-center items-center space-y-5 pb-10 md:flex-row md:space-x-10'>
                    {FooterList.map((item, index) => (
                        ...
                        >
                            <h2 className='text-white font-semibold font-mono italic text-xl'>{item.footerTitel}</h2>
            ...
            >
                <div>
                    <h2 className='text-gray-300 font-semibold font-mono italic'>Copyright Degic © 2020</h2>
                </div>
                <div className='text-white text-xl flex gap-4'>
                    <motion.button whileHover={{ scale: 1.2 }}><a href=""><i className="fa-brands fa-facebook"></i></a></motion.button>
                    <motion.button whileHover={{ scale: 1.2 }}><a href=""><i className="fa-brands fa-github"></i></a></motion.button>
                    <motion.button whileHover={{ scale: 1.2 }}><a href=""><i className="fa-brands fa-linkedin"></i></a></motion.button>
                </div>
            </motion.section>
        </>
    );
